...
public class Constants {
	...
	public static final int X_MAX = 1200;
	...
	public final static int NUM_RANDOM_BALLS = 600;
	
	public final static double AREA_MASS_DEPENDENCE = 2;
	public final static double MAX_VELOCITY = 300;
